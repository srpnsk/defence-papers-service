...
data = {
    ...
    "end_of_postgrad_date": "15.06.2025",
    ...
    "applicant_PG_reference_date": "15.06.2026",
    ...
    "data_publishing_MEPhI": "01.11.2026",
...
# Добавляем пустые поля для статей/конференций/тезисов/РИД, чтобы модель приняла
for i in range(4, 17):
