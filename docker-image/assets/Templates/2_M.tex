    ...
    В период подготовки диссертации соискатель \usekomavar{applicant_full_name_I} обучался в \usekomavar{applicant_PG_study} и работал в \usekomavar{applicant_job_organisation} в должности \usekomavar{applicant_main_job} кафедры №~\usekomavar{applicant_job_department_number} 
    \ifnum\theaajob=0
